...
import { selectOtpToken, selectOtpPhoneNumber } from "@/redux/auth/authSlice";
...
const Otp = () => {
  ...
  const otpPhoneNumber = useSelector(selectOtpPhoneNumber);
  ...
  return (
    <MainContainer>
      <ContainerOtp title={"OTP"} onSubmit={handleSubmit(foo)}>
        ...
        <Button1 isLoading={isLoading}>Verify</Button1>
      </ContainerOtp>
    </MainContainer>
  );
};
